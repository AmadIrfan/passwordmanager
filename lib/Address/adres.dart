...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: Provider.of<AddressDate>(context).fatchData(),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          return Consumer<AddressDate>(
            builder: (context, listItems, child) => listItems.itemsList.isEmpty
                ? Container(
